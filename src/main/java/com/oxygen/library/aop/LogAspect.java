package com.oxygen.library.aop;
...
public class LogAspect {
    ...
    @Pointcut("execution(public * com.oxygen.library.controller..*.*(..)) &&" +
            "!execution(public * com.oxygen.library.controller..BatchController.*(..)) &&" +
            "!execution(public * com.oxygen.library.controller.WechatController.release(int))")
